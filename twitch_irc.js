...
Twitch_irc_client.prototype.say = function(channel, message)
{
    if (message)
...
Twitch_irc_client.prototype.action = function(channel, message)
{
    if (message)
...
Twitch_irc_client.prototype.on_message = function(callback)
{
    ...
    {
            callback(channel.slice(1), user.username, message, function (msg) {
                self_obj.say(msg);
            },function (to,msg) {
